package org.dclar.h2e.tag.util;
...
public class TagUtil {
     ...
     * @return
     */
    public static String replaceWith(String content, Map<String, String> map) {
        final String[] x = {null};
        ...
        while (it.hasNext()) {
            ...
            content = content.replace(m.getKey().toString(), m.getValue().toString());
        }
